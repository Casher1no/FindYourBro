            ...
            @if(!$search)
                <div class="container h-100">
                    <div class="row align-items-center" style="height: 600px">
                        <div class="col-12 mx-auto">
                            <div class="jumbotron">
                                <h3 class="text-center w-100">No bros, you can try to change filters in
                                    <a id="link-edit-profile" href="{{ route('configuration') }}">Edit Filters</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12 mx-auto">
                            <div class="jumbotron">
                                <div class="card m-auto" id="swipe-card"
                                    ...
                                    <img src="{{asset('images/' . $swipe['image_path'])}}" class="card-img-top"
                                         alt="...">
                                    <div class="card-body">
                                    ...
                                    <div class="w-70 h-25 m-auto pt-5">
                                        <div>
                                            ...
                                            <a class="btn btn-primary" title="Follow" id="btn-submit" href="{{ route('follow',['id'=>$swipe['id']]) }}"
                                               role="button">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                            ...
                                            <a class="btn btn-primary" title="Gallery" id="btn-submit" href="{{ route('view-gallery',['id'=>$swipe['id']])}}"
                                               role="button">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
